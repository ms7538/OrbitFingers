...
public class TopFiveActivity extends AppCompatActivity {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (success) {
                            ...
                            Toast.makeText(getBaseContext(), "Failed To Get Top 5 Data",
                                    Toast.LENGTH_LONG).show();
                            AlertDialog.Builder builder = new AlertDialog.Builder(
                                    TopFiveActivity.this);
                            builder.setMessage("Top 5 Failed")
    ...
    private void set_Highlight(int pos){
        ...
        if(NT5_Visible) tr_NT5.setVisibility(View.VISIBLE);
    ...
    private void no_IC_alert(){
        AlertDialog.Builder builder = new AlertDialog.Builder(TopFiveActivity.this);
